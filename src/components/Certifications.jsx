          ...
          >
            ...
            >
              {certifications.map((cert) => (
                ...
                >
                  <Card className="h-full p-6 bg-[#0c0c0f] border-zinc-800/80 hover:border-zinc-500 transition-all duration-300 rounded-3xl flex flex-col justify-between group hover:shadow-[0_25px_50px_rgba(0,0,0,0.9)]">
                    <div className="space-y-4">
                      <div className="flex items-center gap-4">
                        <div className="w-16 h-16 sm:w-20 sm:h-20 flex items-center justify-center bg-zinc-950 border border-zinc-800 rounded-2xl p-2 flex-shrink-0 group-hover:border-zinc-500 transition-colors">
                          <img
                            src={cert.logo}
                            alt={cert.name}
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 text-xs font-bold uppercase text-white hover:text-zinc-300 pt-4 mt-2 border-t border-zinc-900 transition-colors relative z-20"
                    >
